...
class TestJanitorCLIExists:
    ...
    def test_janitorcli_class_exists(self):
        ...
        import janitor_cli
        assert hasattr(janitor_cli, "JanitorCLI"), "JanitorCLI class not found in janitor_cli module"
    ...
    def test_janitorcli_has_skin_force_property(self):
        ...
        import janitor_cli
        assert hasattr(janitor_cli.JanitorCLI, "force_skin") or \
               hasattr(janitor_cli.JanitorCLI, "get_skin_name") or \
               "skin" in dir(janitor_cli.JanitorCLI), \
...
class TestJanitorCommand:
    ...
    def test_janitor_command_available_in_path(self):
        ...
        result = subprocess.run(
            ...
            capture_output=True,
            text=True,
            env={**subprocess.os.environ.copy(), "HERMES_QUIET": "1", "OPENAI_API_KEY": "test-key"},
        )
...
class TestJanitorCLIBranding:
    ...
    def test_janitorcli_force_skin_is_true(self):
        ...
        import janitor_cli
        jcli = janitor_cli.JanitorCLI.__new__(janitor_cli.JanitorCLI)
        assert jcli.force_skin is True, \
            "JanitorCLI.force_skin must be True"
